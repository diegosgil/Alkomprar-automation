...
public class VerificarArticulos implements Task {
    private String categoria;   //NO EXISTE EN EL StepDefinitios

    public VerificarArticulos(String categoria) {
        this.categoria = categoria;
    }

    public static Performable elemento(String categoria) {
        return instrumented(VerificarArticulos.class, categoria);
    }
